...
const find2Ball = ((array) => {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        if (firstScale.length !== 3) {
            ...
            if (secondScale.length !== 3) {
                if (firstScaleIndex.includes(randomIndex) || secondScaleIndex.includes(randomIndex)) {
                    i = 0;
                    continue
                };
    ...
    return {firstScale, firstScaleIndex, secondScale, secondScaleIndex, restElements, restElementsIndex};
})(balls);

console.log(`\nFirst Scale: ${find2Ball.firstScale}\nFirst Scale indexes: ${find2Ball.firstScaleIndex}\n`);
console.log(`Second Scale: ${find2Ball.secondScale}\nSecond Scale indexes: ${find2Ball.secondScaleIndex}\n`);
console.log(`Rest two elements: ${find2Ball.restElements}\nRest two elements indexes:  ${find2Ball.restElementsIndex}`);